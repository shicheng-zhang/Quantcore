        ...
        try:
            ...
            if results:
                ...
                with open("data/hivemind_ui.json", "w") as f:
                    json.dump({
                        "active": True, "sequence": bridge.sequence,
                        "assets": [best_pair['s1'], best_pair['s2']], "weights": [0.5, 0.5],
                        "regime_vol": bridge.regime_vol, "cpp_slippage": cpp_slip,
                        "cpp_pnl": cpp_pnl, "cpp_orders": cpp_orders,
                        "py_timestamp": bridge.py_timestamp, "cpp_timestamp": bridge.cpp_timestamp
                    }, f)
            else:
